<div class="mi-wrap">
        ...
        <section id="stepSetup" class="card">
            ...
            <p class="hint">If you add a <a href="https://aistudio.google.com/apikey" target="_blank" rel="noopener">Google AI Studio</a> key, questions and final scoring use Gemini. If the browser blocks the request (CORS) or you leave this blank, the app uses builtâ€‘in role templates and a local rubric instead.</p>
        ...
        <section id="stepInterview" class="card hidden">
            <div class="pill">Step 2 â€” Answer with voice</div>
            <div class="progress"><div id="progressBar"></div></div>
            <div class="q-label" id="qIndexLabel"></div>
            <p class="question-text" id="questionText"></p>
            <div class="mic-wrap">
                <button type="button" class="mic" id="btnMic" title="Toggle microphone" aria-pressed="false">ðŸŽ™</button>
            ...
            <div class="field">
                ...
                <textarea id="transcript" placeholder="Your spoken answer appears hereâ€¦"></textarea>
            </div>
            <div class="btn-row">
        ...
        <section id="stepResults" class="card hidden">
            <div class="pill">Step 3 â€” Feedback</div>
        ...
        <p class="footer-note">Voice capture uses your browserâ€™s speech recognition (Chrome or Edge recommended). Use HTTPS or localhost for reliable microphone access.</p>
                    </div>
