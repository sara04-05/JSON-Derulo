        ...
        <section class="study-buddy-works">
           <span class="wow-badge">PRACTICE &amp; INSTANT FEEDBACK</span>
            ...
            <div class="study-buddy-grid">
                <div class="study-buddy-card" data-sb-type="explanation" data-protected-tool="study-buddy">
                    ...
                    <button type="button" class="study-buddy-btn" data-sb-type="explanation" data-protected-tool="study-buddy">Execute</button>
                </div>
                ...
                <div class="wow-layout">
                    <div class="wow-content-card">
                        ...
                        <div id="sb-setup-form" class="mi-setup">
                            ...
                            <div class="field">
                                <label for="sb-geminiKey">Gemini API key (Optional)</label>
                                <input type="password" id="sb-geminiKey" placeholder="Paste key for generation" autocomplete="off">
                            </div>
